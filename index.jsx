...
class App extends Component {
	...
	render() {
		...
		return <div className='zmiti-main-ui'>
			...
			<canvas draggable='true' ref='stage' style={{border:'1px solid #999',margin:4,position:'absolute',top:200}} width={this.state.canvasW*this.state.picLen} height={this.state.canvasH*this.state.picLen}></canvas>
		</div>
	}
	...
	setDrag() {
		...
		this.createList().map((item, i) => {
			this.refs['canvas_' + item].index = i;
